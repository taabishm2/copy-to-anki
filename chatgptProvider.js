                ...
                messages: [
                    {
                        ...
                        content: `
                            ...
                            Ignore all HTML tags—use only the visible text. Output *only* the question. Match the language of your output question to the primary language used in the provided text snippet; do not default to English unless the snippet is primarily in English. The following HTML snippet comes from a page titled "${pageTitle}" (${pageUrl})
